...
class StationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create station" do
    assert_difference('Station.count') do
      post stations_url, params: { station: { line: @station.line, name: @station.name, time: @station.time } }
    end
  ...
  test "should update station" do
    patch station_url(@station), params: { station: { line: @station.line, name: @station.name, time: @station.time } }
